...
function WalletAvatar({address, ensImage, size}: AvatarComponentProps) {
  ...
  return ensImage ? (
    <Avatar className={sizeClass}>
      <AvatarImage src={ensImage}/>
      <AvatarFallback className={bg}></AvatarFallback>
    </Avatar>
  ) : (
    <Avatar className={sizeClass}>
      <AvatarFallback className={bg}>{emoji}</AvatarFallback>
    </Avatar>
  )
}
